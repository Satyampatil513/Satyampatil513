...
- **AI & Agents:** Gemini API, RAG, LangGraph, prompt engineering, structured outputs, local LLM integration
- **Infrastructure & Tools:** Docker, Git, CI/CD, SELinux/Security
...
### [Rankit](#) <!-- Add your actual repo link here -->
**AI-powered JEE mock test platform.** (Active Startup)
Students at local coaching institutes lack the AI-powered analytics big institutes have. Rankit solves this by analyzing test performance across topics, time, and difficulty, and suggests personalized Daily Practice Problems using a LangGraph pipeline. *(Tech: FastAPI, PostgreSQL, Vite, Python)*

### SELinux Automation Pipeline @ Samsung
